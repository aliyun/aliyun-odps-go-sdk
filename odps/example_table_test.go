...
func ExampleTable_GetPrimaryKey() {
	schema := tableschema.NewSchemaBuilder().Name("has_pk").PrimaryKeys([]string{"id", "name"}).Column(tableschema.Column{Name: "id", Type: datatype.IntType, NotNull: false}).
...
func ExampleTable_IsTransactional() {
	schema := tableschema.NewSchemaBuilder().Name("deltaTable").PrimaryKeys([]string{"id", "name"}).Column(tableschema.Column{Name: "id", Type: datatype.IntType, NotNull: false}).
		Column(tableschema.Column{Name: "name", Type: datatype.StringType, NotNull: true}).
		Column(tableschema.Column{Name: "name2", Type: datatype.StringType, NotNull: false}).
