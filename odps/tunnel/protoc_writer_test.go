...
func TestConvert(t *testing.T) {
	// BigInt -> int64
	var bigIntValue data.BigInt = 100
	int64Value := int64(bigIntValue)
	fmt.Printf("int64Value: %v, type: %T\n", int64Value, int64Value)

	// int64 -> BigInt
	var anotherInt64 int64 = 200
	bigIntAgain := data.BigInt(anotherInt64)
	fmt.Printf("bigIntAgain: %v, type: %T\n", bigIntAgain, bigIntAgain)
}
